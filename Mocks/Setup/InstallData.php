...
namespace SchumacherFM\Mocks\Setup;
...
class InstallData implements InstallDataInterface
{
    ...
    /**
     * Why runs the installer for two MSRP attributes?
     * We need to add EAV attributes `msrp` and `msrp_display_actual_price_type`
     * because they are referenced somewhere deep in M2 source code.
     *
     * {@inheritdoc}
     */
